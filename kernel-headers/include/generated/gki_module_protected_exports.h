 ...
 * DO NOT EDIT
 *
 * Build generated header file with protected_exports
 */

#define NR_PROTECTED_EXPORTS_SYMBOLS \
	(ARRAY_SIZE(gki_protected_exports_symbols))
#define MAX_PROTECTED_EXPORTS_NAME_LEN (39)

static const char gki_protected_exports_symbols[][MAX_PROTECTED_EXPORTS_NAME_LEN] = {
	"__hci_cmd_send",
	"__hci_cmd_sync",
	"__hci_cmd_sync_ev",
	"__hci_cmd_sync_sk",
